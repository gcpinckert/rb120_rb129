...
=begin
The problem here is that the sort method relies on the <=> method, which we have not
defined for the Length class. By defining the method, sort will be able to perform
it's normal function on the array in line 70.
=end